      ...
      <aside className={`sidebar ${isSidebarCollapsed ? 'collapsed' : ''} ${isMobileMenuOpen ? 'open' : ''}`}>
        <div>
          ...
          <ul className="nav-links">
            <li className={activeModule === 'itemEntrance' ? 'active' : ''} onClick={() => { setActiveModule('itemEntrance'); setIsMobileMenuOpen(false); }}><PackageSearch size={20}/> <span>Item Entrance</span></li>
            <li className={activeModule === 'workActivity' ? 'active' : ''} onClick={() => { setActiveModule('workActivity'); setIsMobileMenuOpen(false); }}><Briefcase size={20}/> <span>Work Activity</span></li>
            <li className={activeModule === 'settings' ? 'active' : ''} onClick={() => { setActiveModule('settings'); setIsMobileMenuOpen(false); }}><Settings size={20}/> <span>Settings</span></li>
          </ul>
        </div>
