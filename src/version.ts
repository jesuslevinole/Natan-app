...
export const CHANGELOG: ChangelogEntry[] = [
  ...
  },
  {
    ...
    date: '2026-09-22',
    items: [
      'The translate and delete buttons next to each chat message are now always visible (before they only appeared on hover), in the Chat module and in the floating bubble.',
    ],
  },
  {
    version: 'V0042',
